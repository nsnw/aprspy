...
class ParseWarningCode(Enum):
    ...
    NMEA_TRAILING_DATA = "NMEA_TRAILING_DATA"
    ...
    TIMESTAMP_FIELD_ORDER_SWAPPED = "TIMESTAMP_FIELD_ORDER_SWAPPED"
    ...
    # Messages
    MESSAGE_MISSING_SEPARATOR = "MESSAGE_MISSING_SEPARATOR"

    # Objects
    OBJECT_NONSTANDARD_INDICATOR = "OBJECT_NONSTANDARD_INDICATOR"
    OBJECT_MISSING_INDICATOR = "OBJECT_MISSING_INDICATOR"
    ...
    ULTIMETER2000_PARSE_FAILED = "ULTIMETER2000_PARSE_FAILED"
